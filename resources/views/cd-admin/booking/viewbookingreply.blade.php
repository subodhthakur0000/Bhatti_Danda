                ...
                <table class="table table-hover table-striped">
                  ...
                  <tr>
                    <td class="mailbox-star"><button class="btn btn-danger" data-toggle="modal" data-target="#modal-danger{{$re->id}}"><i class="fa fa-trash"> </i></button>
                      ...
                      <button class="btn btn-primary " data-toggle="modal" data-target="#view{{$re->id}}"><i class="fa fa-eye">
                      </i></button>
                    </td>
                     
                        <td class="mailbox-subject"><strong>{{$re->email}}</strong>
...
<div class="modal modal-danger fade" id="modal-danger{{$t->id}}">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <a href="{{url('/deletebookingreply/'.$t->id)}}"> <button type="button" class="btn btn-outline">Yes</button></a>
              </div>
            </div>
            <!-- /.modal-content -->
          </div>
